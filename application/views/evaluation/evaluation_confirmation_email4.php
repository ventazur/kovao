        ...
        <tr>
            ...
            <td class="container">
                <div class="content">
                    ...
                    <div style="padding: 15px; background: #444; color: skyblue; font-weight: 100">
                        KOVAO
                    </div>
                                        ...
                                        <td>
                                            ...
                                            <p>
                                                <div style="padding-top: 10px; padding-bottom: 10px;">
                                                    <div style="margin: auto; border: 1px solid #444; border-radius: 3px; text-align: center; padding: 20px; width: 350px;">
