...
/* ============================================================================
 *
 * Un avertissement a ete detecte dans votre evaluation
 *
 * ============================================================================ */ ?>

<div class="avertissement">
    <div class="avertissement-titre">
        <strong>AVERTISSEMENT</strong> : <?= $erreur['code']; ?>
    </div>
    <div class="avertissement-message">
        <i class="fa fa-exclamation-circle" style="color: darkorange; margin-right: 5px"></i> <?= $erreur['message']; ?>
    </div>
    <div class="avertissement-solution">
        <span style="color: darkorange; font-weight: bold">Solution : </span> <?= $erreur['solution']; ?>
    </div>

    <? if (array_key_exists('extra', $erreur)) : ?>
        <div class="avertissement-extra">
