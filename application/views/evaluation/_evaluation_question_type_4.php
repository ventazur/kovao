    ...
    <? foreach($reponses_question as $r) : ?>
        ...
        <div class="question-reponse">
            ...
            <div class="form-check">
                <input name="question_<?= $question_id; ?>[]" class="form-check-input" type="checkbox" 
                       value="<?= $r['reponse_id']; ?>" <?= is_array($traces) && array_key_exists($question_id, $traces) && in_array($r['reponse_id'], $traces[$question_id]) ? 'checked' : ''; ?>>
