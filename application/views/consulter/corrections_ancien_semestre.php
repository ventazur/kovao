<div id="corrections-ancien-semestre">
    ...
    <div style="border: 1px solid crimson; padding: 20px; font-weight: 300">
        ...
        <table>
            <tr>
                ...
                <td>
                    Il n'est pas possible de consulter les corrections d'une évaluation complétée à un semestre précédent.<br />
                    Si vous voulez revoir vos corrections, veuillez contacter votre enseignant.
                </td>
            </tr>
        </table>
...
</div> <!-- #corrections-ancien-semestre -->
