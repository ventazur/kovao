...
/* ----------------------------------------------------------------------------
 *
 * MES ARCHIVES (MES EVALUATIONS ARCHIVEES)
 *
 * ----------------------------------------------------------------------------
 *
 * Version 1 (2023/01/13)
 *
 * ---------------------------------------------------------------------------- */ ?>
    ...
    <div class="col-sm-12 col-xl-10">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <h3>Mes évaluations archivées</h3>

            </div>

            <div class="col" style="text-align: right">
            
                <a class="btn btn-outline-primary mt-2 mt-md-0" href="<?= base_url() . $current_controller; ?>">
                    Mes évaluations
                </a>
