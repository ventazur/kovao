...
/* ----------------------------------------------------------------------------
 * 
 * Resultats > Conformite > La meme evaluation (sans considerer l'ordre)
 *
 * ---------------------------------------------------------------------------- */ ?>

<div class="conformite-evaluation-precisions-titre">

    Ces étudiants avaient la <strong>même évaluation</strong> :
...
<div class="conformite-evaluation-precisions-contenu">
    ...
    <div class="conformite-explications">
        ...
        Ces étudiants avaient les mêmes questions (sans considérer l'ordre de présentation de ces questions).
    </div>

    <table class="conformite-evaluation-precisions-table">

    <? foreach($evaluations2_unique as $ref => $soumission_ids) : ?> 
