            ...
            <div id="navbar" class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbar-contenu">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" style="font-family: Lato; font-weight: 300; color: #ddd;" href="https://<?= $this->config->item('sous_domaine'); ?>.kovao.com">
                                Accueil
                            </a>
                        </li>
        ...
        <div id="erreur">
            <div class="container" style="margin-top: 110px">
                ...
                <div style="padding: 40px; border: 1px solid #ddd; border-radius: 3px">
                    ...
                    Erreur : <strong>DEV</strong>

                    <br /><br />

                    Vous ne pouvez accéder la version en développement de KOVAO.

                    <div style="margin-top: 20px"></div>

                    Veuillez vous rediriger vers le site officiel :

                    <div style="margin-top: 20px"></div>

                    <a class="btn btn-outline-primary" style="font-family: Lato; font-weight: 300;" href="https://<?= $this->config->item('sous_domaine'); ?>.kovao.com">
                    
                        https://<?= $this->config->item('sous_domaine'); ?>.kovao.com
