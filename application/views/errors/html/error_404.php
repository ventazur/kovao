            ...
            <div id="navbar" class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbar-contenu">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" style="font-family: Lato; font-weight: 300; color: #ddd;" href="/">Accueil</a>
                        </li>
        ...
        <div id="erreur">
            <div class="container" style="margin-top: 110px">
                ...
                <div style="padding: 40px; border: 1px solid #ddd; border-radius: 3px">
                    ...
                    Erreur : <strong>404</strong>

                    <br /><br />

                    Nous n'avons pas été en mesure de trouver la page demandée.

                    <div class="space"></div>

                    Cette erreur peut être causée si un lien s'est brisé sur le site. Si cela est le cas, veuillez contacter l'administrateur.
