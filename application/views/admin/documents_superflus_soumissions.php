...
/* ----------------------------------------------------------------------------
 *
 * Admin > Documents superflues des soumissions
 *
 * ---------------------------------------------------------------------------- */ ?>

<div id="admin-documents-superflus-soumissions">
...
<div class="row">
    ...
    <div class="col-sm-12 col-xl-10">
        ...
        <h4>Admin <i class="fa fa-angle-right" style="margin-left: 10px; margin-right: 10px"></i>Documents superflus des étudiants (<?= count($documents_superflus); ?>) [des soumissions]</h4>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">
                                <? if ($d['s3']) : ?>
                                    ...
                                    <a href="<?= $this->config->item('s3_url', 'amazon') . 'soumissions/' . $d['doc_filename']; ?>" target="_blank">
