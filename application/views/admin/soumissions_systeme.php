...
/* ----------------------------------------------------------------------------
 *
 * Administration > Systeme > Soumissions
 *
 * ---------------------------------------------------------------------------- */ ?>

<div id="admin-systeme-soumissions">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= array_key_exists($s['groupe_id'], $groupes) ? $groupes[$s['groupe_id']]['sous_domaine'] : ''; ?></td>
                            ...
                            <td style="text-align: center">
                                <? if ($s['permettre_visualisation']) : ?>
                                    ...
                                    <i class="fa fa-eye" style="color: limegreen;"></i>

                                <? else : ?>

                                    <i class="fa fa-eye-slash" style="color: crimson;"></i>
