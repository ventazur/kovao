...
<div class="col-sm-12 col-xl-10">
    ...
    <div class="row">
        ...
        <div class="col-4" style="text-align: right">
            <? if ($this->enseignant['privilege'] >= 90) : ?>
                <a href="<?= base_url() . 'admin'; ?>"  class="btn btn-outline-dark">
    ...
    <div id="sous-menu" class="btn-group btn-block" role="group">
        <a class="btn btn-sm spinnable <?= $onglet == 'alertes' ? 'active' : ''; ?>" href="<?= base_url() . 'admin/groupe/alertes'; ?>" style="width: 120px">
            Alertes
            <i class="spinner fa fa-circle-o-notch fa-spin d-none" style="margin-left: 5px; margin-right: -22px;"></i>
        </a>
        <a class="btn btn-sm spinnable <?= $onglet == 'activite' ? 'active' : ''; ?>" href="<?= base_url() . 'admin/groupe/activite'; ?>" style="width: 120px">
            Activité
            <i class="spinner fa fa-circle-o-notch fa-spin d-none" style="margin-left: 5px; margin-right: -22px;"></i>
        </a>
        <a class="btn btn-sm spinnable <?= $onglet == 'enseignants' ? 'active' : ''; ?>" href="<?= base_url() . 'admin/groupe/enseignants'; ?>" style="width: 120px">
            Enseignants
            <i class="spinner fa fa-circle-o-notch fa-spin d-none" style="margin-left: 5px; margin-right: -22px;"></i>
        </a>
        <a class="btn btn-sm spinnable <?= $onglet == 'evaluations' ? 'active' : ''; ?>" href="<?= base_url() . 'admin/groupe/evaluations'; ?>" style="width: 120px">
            Évaluations
            <i class="spinner fa fa-circle-o-notch fa-spin d-none" style="margin-left: 5px; margin-right: -22px;"></i>
        </a>
        <a class="btn btn-sm spinnable <?= $onglet == 'soumissions' ? 'active' : ''; ?>" href="<?= base_url() . 'admin/groupe/soumissions'; ?>" style="width: 120px">
            Soumissions
            <i class="spinner fa fa-circle-o-notch fa-spin d-none" style="margin-left: 5px; margin-right: -22px;"></i>
        </a>
        <a class="btn btn-sm spinnable <?= $onglet == 'consultations' ? 'active' : ''; ?>" href="<?= base_url() . 'admin/groupe/consultations'; ?>" style="width: 120px">
            Consultations
            <i class="spinner fa fa-circle-o-notch fa-spin d-none" style="margin-left: 5px; margin-right: -22px;"></i>
        </a>
    </div>
    ...
    <? if ($onglet == 'alertes') : ?>
        <div>
            <? $this->load->view('admin/alertes_groupe', $this->data); ?>
        </div>
    <? endif; ?>
    ...
    <? if ($onglet == 'activite') : ?>
        <div>
            <? $this->load->view('admin/activite_groupe', $this->data); ?>
        </div>
    <? endif; ?>
    ...
    <? if ($onglet == 'enseignants') : ?>
        <div>
            <? $this->load->view('admin/enseignants_groupe', $this->data); ?>
        </div>
    <? endif; ?>
    ...
    <? if ($onglet == 'enseignant') : ?>
        <div>
            <? $this->load->view('admin/enseignant_groupe', $this->data); ?>
        </div>
    <? endif; ?>
    ...
    <? if ($onglet == 'evaluations') : ?>
        <div>
            <? $this->load->view('admin/evaluations_groupe', $this->data); ?>
        </div>
    <? endif; ?>
    ...
    <? if ($onglet == 'soumissions') : ?>
        <div>
            <? $this->load->view('admin/soumissions_groupe', $this->data); ?>
        </div>
    <? endif; ?>
    ...
    <? if ($onglet == 'consultations') : ?>
        <div>
            <? $this->load->view('admin/consultations_groupe', $this->data); ?>
        </div>
    <? endif; ?>
