...
<div class="col-sm-12 col-xl-10">
    ...
    <h3>Administration d'un département</h3>

    <div class="space"></div>
    
    <h4 style="font-weight: 300"><?= $adm_ecole['ecole_nom']; ?> <i class="fa fa-angle-right" style="margin-left: 7px; margin-right: 7px"></i> <?= $adm_groupe['groupe_nom']; ?></h4>
    ...
    <div class="groupe-section">
        ...
        <div class="groupe-section-box">
		 	...
		 	<div class="form-inline row" style="margin-top: 2px">
				...
				<div class="col-9">
					<div class="btn-group btn-group-toggle" data-toggle="buttons">
						<label id="inscription-permise-oui" class="btn btn-outline-primary <?= $this->groupe['inscription_permise'] ? 'active' : ''; ?>" style="width: 60px">
							<input type="radio" name="inscription_permise" value="oui" autocomplete="off" <?= $this->groupe['inscription_permise'] ? 'checked' : ''; ?>> oui
						</label>
						<label id="inscription-permise-non" class="btn btn-outline-primary <?= $this->groupe['inscription_permise'] ? '' : 'active'; ?>" style="width: 60px">
							<input type="radio" name="inscription_permise" value="non" autocomplete="off" <?= $this->groupe['inscription_permise'] ? '' : 'checked' ?>> non
						</label>
					</div>
			</div>
			</div> <!--  .form-inline -->
			...
			<div class="form-inline row">
				...
				<div class="col-9">
					<input type="text" class="form-control" name="code_inscription" id="code-inscription" autocomplete="off" value="<?= $this->groupe['inscription_code']; ?>">
					<div id="code-inscription-sauvegarder" class="btn btn btn-outline-success d-none" style="margin-left: 10px">
						<i class="fa fa-save"></i> 
						Sauvergarder
						<i id="code-inscription-sauvegarder-spinner" class="fa fa-circle-o-notch fa-spin d-none"></i>
					</div>
        ...
        <div class="groupe-section-box">
            ...
            <? else : ?>
                ...
                <table id="semestres" class="table" style="margin-top: -10px; margin-bottom: 0; border-bottom: 1px solid #ddd">
                    ...
                    <? foreach($adm_semestres as $semestre_id => $s) : ?>
            ...
            <div class="btn btn-outline-primary" data-groupe_id="<?= $adm_groupe_id; ?>" data-toggle="modal" data-target="#modal-ajouter-semestre">
    ...
    <div class="groupe-section">
        ...
        <div class="groupe-section-box">
            ...
            <div class="btn btn-outline-primary" data-groupe_id="<?= $adm_groupe_id; ?>" data-toggle="modal" data-target="#modal-ajouter-cours">
        ...
        <div class="groupe-section-box">
            ...
            <? else : ?>
                ...
                <table id="enseignants" class="table" style="margin-top: -10px; margin-bottom: 0; border-bottom: 1px solid #ddd">
                    <tr>
                        <th>Prénom et Nom</th>
                        <th style="text-align: center">Courriel confirmé</th>
                        <th style="text-align: center">Niveau</th>
                        <th style="text-align: center">Actif</th>
						<th>Opérations</th>
                    </tr>

                    <? foreach($adm_enseignants as $e) : ?>

                        <tr>
                            <td style="padding-top: 15px"><?= $e['prenom'] . ' ' . $e['nom']; ?></td>
                            <td style="text-align: center; padding-top: 15px"><i class="fa fa-<?= ($e['courriel_confirmation'] ? 'check' : 'times'); ?>-circle"></i></td>
                            ...
                            <td>
								<? if ($enseignant['niveau'] >= $e['niveau'] || $enseignant['enseignant_id'] == $e['enseignant_id']) : ?>
                                    ...
                                    <? else : ?>
                                        <div data-enseignant_id="<?= $e['enseignant_id']; ?>" class="activer-enseignant btn btn-outline-primary btn-sm">
                                ...
                                <? if ($enseignant['niveau'] >= $this->config->item('admin_groupe', 'niveaux') && $e['niveau'] >= $this->config->item('admin_groupe', 'niveaux')) : ?>

                                    <div data-enseignant_id="<?= $e['enseignant_id']; ?>" data-groupe_id="<?= $adm_groupe['groupe_id']; ?>"
                                            class="changer-responsable btn btn-sm btn-outline-primary <?= $adm_groupe['admin_enseignant_id'] == $e['enseignant_id'] ? 'active' : ''; ?>">
            ...
            <div class="btn btn-outline-primary" data-groupe_id="<?= $adm_groupe_id; ?>" data-toggle="modal" data-target="#modal-ajouter-enseignant">
                <i class="fa fa-plus-circle"></i> Ajouter un enseignant
            </div>
