...
<style>
    .recherche-resultats-section-contenu table tr:hover {
        background: #E3F2FD;
    }
</style>

<div class="recherche-resultats-contenu">

    <div class="recherche-resultats-section-titre" style="color: limegreen; font-size: 1.2em">
        Résultats
    </div>

    <div class="recherche-resultats-section-contenu mt-3" style="border: 1px solid #ddd;">
        <table class="table" style="font-size: 0.85em; margin: 0">
            <thead>
                <tr>
                    <th style="width: 100px">Etu ID</th>
                    <th>Nom, Prénom</th>
                    <th class="text-center" style="width: 150px;"><?= $this->ecole['numero_da_nom']; ?></th>
            ...
            <tbody>
                <? foreach($etudiants as $e) : ?>
                    <tr>
                        ...
                        <td style="white-space: nowrap; overflow: hidden; max-width: 1px;">
                            <?= mb_strtoupper($e['nom']) . ', ' . $e['prenom']; ?> 
                            <? if ($e['genre'] == 'F') : ?>
                        ...
                        <td class="mono text-center">[<?= $e['numero_da']; ?>]</td>
